...
<body>
			...
			<div class="wrap-login100">
				...
				<form method="post" id="examineeLoginFrm" class="login100-form validate-form">
					...
					<div class="container-login100-form-btn" align="right">
						...
						<br>
						<a href="sign.php" class="login100-form-btn" style="margin-left: 30px;">SignUp</a>
					</div>
				</form>
	...
	<!-- Adjusted Admin Panel button -->
	<div style="position: fixed; bottom: 10px; left: 10px;">
		<a href="adminpanel/admin/index.php" class="btn btn-primary btn-sm" style="padding: 5px 10px; border-radius: 5px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
			Admin Panel
		</a>
	</div>
