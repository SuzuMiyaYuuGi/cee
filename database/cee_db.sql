-- phpMyAdmin SQL Dump
-- This SQL file has removed course_tbl and columns related to 'course'.
...
-- ตัวอย่างข้อมูล (หากต้องการคงไว้) 
INSERT INTO `examinee_tbl` (`exmne_id`, `exmne_fullname`, `exmne_gender`, `exmne_birthdate`, `exmne_year_level`, `exmne_email`, `exmne_password`, `exmne_status`) VALUES
(4, 'Rogz Nunezsss', 'male', '2019-11-15', 'third year', 'rogz.nunez2013@gmail.com', 'rogz', 'active'),
(5, 'Jane Rivera', 'female', '2019-11-14', 'second year', 'jane@gmail.com', 'jane', 'active'),
(6, 'Glenn Duerme', 'female', '2019-12-24', 'third year', 'glenn@gmail.com', 'glenn', 'active'),
(7, 'Maria Duerme', 'female', '2018-11-25', 'second year', 'maria@gmail.com', 'maria', 'active'),
(8, 'Dave Limasac', 'female', '2019-12-21', 'second year', 'dave@gmail.com', 'dave', 'active');


-- --------------------------------------------------------
--
-- Table structure for table `exam_tbl`
--  (ลบคอลัมน์ cou_id ออก)
--
...
INSERT INTO `exam_tbl` (`ex_id`, `ex_title`, `ex_time_limit`, `ex_questlimit_display`, `ex_description`, `ex_created`) VALUES
(11, 'Duerms', '1', 2, 'qwe', '2019-12-05 12:03:21'),
(12, 'Another Exam', '1', 5, 'Mabilisang Exam', '2019-12-04 15:19:18'),
(13, 'Exam Again', '5', 0, 'again and again\r\n', '2019-11-30 08:24:54');
